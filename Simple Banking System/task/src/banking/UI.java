...
public class UI {
    ...
    private String createAccount() {
        ...
        //String tempNum = functions.createNewCard(map); #check function and put inside the database
        String tempNum = functions.createNewCard();
        int pinNum = functions.generatePin();
        //map.put(tempNum, new Account(pinNum)); // put here in the database
    ...
    private void logInAccount(){
        ...
        //functions.findSame(cardNum) &&
        //                map.get(cardNum).getPin() == pinNum
